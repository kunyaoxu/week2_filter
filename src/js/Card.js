...
//                <div className="imgcontainer"><img src={"http://khh.travel/FileArtPic.ashx?id=2080&w=1280&h=960"}/></div>
    return (
      <div className="Card row">
          <div className="imgcontainer col-lg col-12" style={{backgroundImage: "url('http://khh.travel/FileArtPic.ashx?id=1204&w=640')"}}></div>
          <div className="cardmain col-lg col-12 ">
